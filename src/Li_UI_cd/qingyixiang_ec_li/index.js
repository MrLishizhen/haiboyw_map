...
export default class Jindu extends Component {
    ...
    setEcharts = () => {
        ...
        let legend = [];
        let legendP=[[36,158],[36,206],[36,254],[292,158],[292,206],[292,254]];
...
rgba(19, 39, 84, 0.9));display:flex;flex-direction: column;justify-content: center;align-content: center;font-size:20px;"><div style="color:#fff;margin-bottom: 8px">${
                        ...
                        <span style='color:#88CDFF;margin-bottom: 8px'>企业数量 <span style="color:rgba(155, 255, 249, 1)">${data1[index]}</span> </span>
                    
                        <span style='color:#88CDFF'>贷款金额 <span style="color:rgba(155, 255, 249, 1)">${data2[index]}</span></span>
                    </div>`
                    }
                }
            })
    ...
    render() {
        return (
            <div ref={node => this.node = node}
                 style={{width: 810, height: 290}}></div>
        )
    }
