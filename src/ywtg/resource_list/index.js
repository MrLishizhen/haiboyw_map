    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className={[styles.ywtg_resource_list_content_wrapper, open ? styles.open : null].join(' ')}>
                    <div style={{ width: 540, height: '100%', overflowY: 'auto' }}>
                        <div style={{ width: 492 }}>
                            {data && data.length > 0 && data.map((item, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className={styles.ywtg_resource_list_item}
