...
const CONST_ITEMS = [
    { key: 'road', icon: 'road', name: '路况', type: 'lbs', exclude: ['shequ', 'wangge', 'shipin'], style: { width: 34, height: 64 }, /*command: `{"type":"SHOW_FEATURELAYER","flag":"GRIDFLAG","pinType":"*","points":[],"params":{"default":true,"pinType":"*","messageType":"clear"},"state":#}`*/ },
    { key: 'shipin', icon: 'shipin', name: '视频监控', type: 'arcgis', exclude: ['road'], style: { width: 56 * 1.3, height: 48 * 1.3 }, command: `{"type":"SHOWNSTATE","flag":"GRIDFLAG","pinType":"*","points":[],"params":{"default":false,"pinType":"*","messageType":"clear"},"state":#}` },
    { key: 'shequ', icon: 'cnBorder', name: '社区', type: 'arcgis', exclude: ['road'], style: { width: 52 * 1.3, height: 50 * 1.3 }, command: `{"type":"SHOWNSTATE","flag":"GRIDFLAG","pinType":"*","points":[],"params":{"default":false,"pinType":"*","messageType":"clear"},"state":#}` },
    { key: 'wangge', icon: 'wangge', name: '网格', type: 'arcgis', exclude: ['road'], style: { width: 44 * 1.3, height: 44 * 1.3 }, command: `{"type":"SHOWNSTATE","flag":"GRIDFLAG","pinType":"*","points":[],"params":{"default":false,"pinType":"*","messageType":"clear"},"state":#}` },
