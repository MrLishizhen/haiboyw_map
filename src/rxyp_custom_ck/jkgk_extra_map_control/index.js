...
// 健康管控
// const CONST_ITEMS = [
//     { key: 'YXGLD', icon: 'YXGLD', type: '医学隔离点', style: { width: '100%', height: '100%' }, float: 'left', command: `click`, exclude: ['XDDQ', 'WYJCD', 'CDMZ', 'FRMZ', 'FRSB', 'JZD'], children: [{ key: 'jjgl', name: '居家隔离' }, { key: 'jzgl', name: '集中隔离' }] },
//     { key: 'XDDQ', icon: 'XDDQ', type: '消毒点位', style: { width: '100%', height: '100%' }, float: 'left', command: `click`, exclude: ['jjgl', 'jzgl', 'YXGLD', 'WYJCD', 'CDMZ', 'FRMZ', 'FRSB', 'JZD'], children: [{ key: 'XDDQ', name: '消毒点位' }] },
//     { key: 'WYJCD', icon: 'WYJCD', type: '蚊蝇监测点', style: { width: '100%', height: '100%' }, float: 'left', command: `click`, exclude: ['jjgl', 'jzgl', 'YXGLD', 'XDDQ', 'CDMZ', 'FRMZ', 'FRSB', 'JZD'], children: [{ key: 'WYJCD', name: '蚊蝇监测点' }] },
//     { key: 'CDMZ', icon: 'CDMZ', type: '肠道门诊', style: { width: '100%', height: '100%' }, float: 'left', command: `click`, exclude: ['jjgl', 'jzgl', 'YXGLD', 'XDDQ', 'WYJCD', 'FRMZ', 'FRSB', 'JZD'], children: [{ key: 'CDMZ', name: '肠道门诊' }] },
//     { key: 'FRMZ', icon: 'FRMZ', type: '发热门诊', style: { width: '100%', height: '100%' }, float: 'left', command: `click`, exclude: ['jjgl', 'jzgl', 'YXGLD', 'XDDQ', 'CDMZ', 'WYJCD', 'FRSB', 'JZD'], children: [{ key: 'FRMZ', name: '发热门诊' }] },
//     { key: 'FRSB', icon: 'FRSB', type: '发热哨点', style: { width: '100%', height: '100%' }, float: 'left', command: `click`, exclude: ['jjgl', 'jzgl', 'YXGLD', 'XDDQ', 'CDMZ', 'FRMZ', 'WYJCD', 'JZD'], children: [{ key: 'FRSB', name: '发热哨点' }] },
//     { key: 'JZD', icon: 'JZD', type: '接种点', style: { width: '100%', height: '100%' }, float: 'left', command: `click`, exclude: ['jjgl', 'jzgl', 'YXGLD', 'XDDQ', 'CDMZ', 'FRMZ', 'FRSB', 'WYJCD'], children: [{ key: 'JZD', name: '接种点' }] },
// ];
