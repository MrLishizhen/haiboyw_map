...
const CONST_ITEMS = [
    { key: 'traffic', icon: 'road', name: '路况', type: 'arcgis', exclude: ['xiangzhenjiedao', 'wangge', 'shipin'], style: { width: 34, height: 64 }, command: `{"type":"SHOWNSTATE","flag":"GRIDFLAG","pinType":"*","points":[],"params":{"default":false,"pinType":"*","messageType":"clear"},"state":#}` },
    { key: 'shipin', icon: 'shipin', name: '视频监控', type: 'arcgis', exclude: ['traffic'], style: { width: 56 * 1.3, height: 48 * 1.3 }, command: `{"type":"SHOWNSTATE","flag":"GRIDFLAG","pinType":"*","points":[],"params":{"default":false,"pinType":"*","messageType":"clear"},"state":#}` },
    { key: 'xiangzhenjiedao', icon: 'cnBorder', name: '街道', type: 'arcgis', exclude: ['traffic', 'wangge'], style: { width: 52 * 1.3, height: 50 * 1.3 }, command: `{"type":"SHOWNSTATE","flag":"GRIDFLAG","pinType":"*","points":[],"params":{"default":false,"pinType":"*","messageType":"clear"},"state":#}` },
    { key: 'wangge', icon: 'wangge', name: '网格', type: 'arcgis', exclude: ['traffic', 'xiangzhenjiedao'], style: { width: 44 * 1.3, height: 44 * 1.3 }, command: `{"type":"SHOWNSTATE","flag":"GRIDFLAG","pinType":"*","points":[],"params":{"default":false,"pinType":"*","messageType":"clear"},"state":#}` },
    { key: 'weixing', icon: 'cameraMaptile', name: '卫星图', type: 'arcgis', exclude: [], style: { width: 64, height: 64 }, command: `{"type":"SHOWNSTATE","flag":"GRIDFLAG","pinType":"*","points":[],"params":{"default":false,"pinType":"*","messageType":"clear"},"state":#}` },
    { key: 'baimo', icon: 'buildingFFF', name: '白模', type: 'arcgis', exclude: [], style: { width: 64, height: 64 }, command: `{"type":"SHOWNSTATE","flag":"GRIDFLAG","pinType":"*","points":[],"params":{"default":false,"pinType":"*","messageType":"clear"},"state":#}` },
];
