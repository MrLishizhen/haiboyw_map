...
const CODEMAP = {"成都市": "5101","锦江区":"510104","青羊区":"510105","金牛区":"510106","武侯区":"510107","成华区":"510108","高新南区":"510109","四川天府新区":"510110","龙泉驿区":"510112","青白江区":"510113","新都区":"510114","温江区":"510115","双流区":"510116","郫都区":"510117","新津区":"510118","高新西区":"510119","金堂县":"510121","大邑县":"510129","蒲江县":"510131","都江堰市":"510181","彭州市":"510182","邛崃市":"510183","崇州市":"510184","简阳市":"510185","成都东部新区":"510186","成都高新区": "510187"}
...
export default class Map_arcgis extends Component {
    ...
    setMarker = () => {
        ...
        result.map((u) => {
            ...
            if (u.exception) {
                u.icon = 'http://10.1.50.86:8090/fastdfs/20220317/aa23f92aaee7703ddd75c908e68a7bea.png';
            } else if (u.highUseClassC) {//高频
                u.icon = 'http://10.1.50.86:8090/fastdfs/20220317/602387c193ecd7f46c188a81ac1714cb.png';
            } else if (u.isSlaOverTime) {
                u.icon = 'http://10.1.50.86:8090/fastdfs/20220317/d4228f2c818ecfc5fdf274f6ece16cef.png';
            } else if (u.major) {//重大
                u.icon = 'http://10.1.50.86:8090/fastdfs/20220317/a93a4aa6c6410fc9ac7e3403843d225d.png'
            }
        ...
        this.bridge && this.bridge.Invoke({
            "ActionName": "ShowData",
            "Parameters": {
                "name": "map_layer",
                "data": {
