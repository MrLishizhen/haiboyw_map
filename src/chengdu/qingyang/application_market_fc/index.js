                        ...
                        <div key={`swiper-slide-${current}`} className='swiper-slide'>
                          ...
                          {array.map((item, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div>
                                            <div className={styles.icon} style={{ backgroundImage: `url(${hover === item.id ? item.active_icon : item.icon})`, ...icon_style }}>
        ...
        return (
            <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                <div className='swiper-container' ref={this.swiperRef} style = {{width: '100%', height: '100%'}}>
                    ...
                    <div className='swiper-pagination' ref={this.paginationRef} />
                </div>
            </div>
        );
    }
