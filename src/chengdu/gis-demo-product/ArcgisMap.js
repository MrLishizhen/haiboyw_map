...
export default class index extends Component {
        ...
        // 乡镇街道
          ...
          param = [{
            ...
            "Parameters": {
              ...
              "type": "polyline",
              "data": {
                "url": "http://10.1.17.8/api-gateway/api-center/runApi/getTrafficJamsInfo?nodeName=青羊区",
                "requestOptions": {
                  "headers": {
    ...
    generateGraphLayer = (data, visible) => {
        ...
        if (this.bridge) {
            ...
            console.log("_source1: ", _source1)
           
            // http://10.1.17.21:8090/fastdfs/group1/M00/00/1E/CgAAaWFMNl-AFkcsAAAQYuolWDE928.png
            this.bridge.Invoke({
              "ActionName": "ShowData",
              "Parameters": {
                "name": pinType,
                ...
                "popupUrl": "http://10.1.17.21:8090/pop.html?width=780&height=580&fjson=msg",
                "legendVisible": false,
                "popupEnabled": true,
                visible,
                "renderer": renderer || {
                  ...
                  "symbol": {
                    "type": "picture-marker",
                    "url": "http://10.1.17.21:8090/fastdfs/group1/M00/00/1E/CgAAaWFMNl-AFkcsAAAQYuolWDE928.png",
                    "width": "64px",
                    "height": "64px"
                  }
                }
