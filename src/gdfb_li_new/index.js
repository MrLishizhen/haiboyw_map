...
export default class index extends Component {
    constructor(props) {
        ...
        let dataQuery = Array.isArray(dataProvider) && dataProvider.length > 0 ? dataProvider : [{name:'X1X酒店',count: 180,glrs:123,address: '樊城区XX街道XX路123号',tel: 15912345678,},{name:'XX酒店',count: 180,glrs:123,address: '樊城区XX街道XX路123号',tel: 15912345678,},{name:'XX酒店',count: 180,glrs:123,address: '樊城区XX街道XX路123号',tel: 15912345678,},{name:'XX酒店',count: 180,glrs:123,address: '樊城区XX街道XX路123号',tel: 15912345678,}];
                                ...
                                let children = child.map((item, i) => {
                                    ...
                                    return (<div className={'box-item'}
                                            ...
                                            <div className={'names'}>
                                                ...
                                                <span className={'countTitle'}>床位 <i
                                                    className={'count'}>{this.format(item?.count || 0)}</i></span>
                                                <span className={'countTitle'}>隔离人数 <i
                                                    className={'count'}>{this.format(item?.glrs || 0)}</i></span>
                                            </div>
                                            <div className={'box-content1'}>
                                                <span className={'countTitle1'}>地址<i className={'count'}>{this.format(item?.address || 0)}</i></span>
                                                <span className={'countTitle1'}>联系人电话<i className={'count'}>{this.format(item?.tel || 0)}</i></span>
                                            </div>
